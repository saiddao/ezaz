package org.EzAz.Layer3Driver.SOAPdriver;
/**
...
public class SOAPDriver extends AsyncEmulator {
	...
	public Response extendedOperation(String operation, Request request,
		...
		throw new genericLayer2RuntimeException("SOAPDriver does not implement extendedOperation!");
	}
