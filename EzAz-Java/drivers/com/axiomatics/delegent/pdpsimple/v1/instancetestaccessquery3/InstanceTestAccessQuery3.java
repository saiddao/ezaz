...
@XmlRootElement(name = "InstanceTestAccessQuery3")
public class InstanceTestAccessQuery3 {
    ...
    protected List<InstanceTestAccessQuery3 .Store> store;
     ...
     * {@link InstanceTestAccessQuery3 .Store }
     * 
     * 
     */
    public List<InstanceTestAccessQuery3 .Store> getStore() {
        if (store == null) {
            store = new ArrayList<InstanceTestAccessQuery3 .Store>();
        }
        return this.store;
    }
