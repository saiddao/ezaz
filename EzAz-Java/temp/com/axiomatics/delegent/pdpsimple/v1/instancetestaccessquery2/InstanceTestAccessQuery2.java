...
@XmlRootElement(name = "InstanceTestAccessQuery2")
public class InstanceTestAccessQuery2 {
    ...
    protected List<InstanceTestAccessQuery2 .Store> store;
     ...
     * {@link InstanceTestAccessQuery2 .Store }
     * 
     * 
     */
    public List<InstanceTestAccessQuery2 .Store> getStore() {
        if (store == null) {
            store = new ArrayList<InstanceTestAccessQuery2 .Store>();
        }
        return this.store;
    }
