...
@XmlRootElement(name = "InstanceTraceTestAccessQuery2")
public class InstanceTraceTestAccessQuery2 {
    ...
    protected List<InstanceTraceTestAccessQuery2 .Store> store;
     ...
     * {@link InstanceTraceTestAccessQuery2 .Store }
     * 
     * 
     */
    public List<InstanceTraceTestAccessQuery2 .Store> getStore() {
        if (store == null) {
            store = new ArrayList<InstanceTraceTestAccessQuery2 .Store>();
        }
        return this.store;
    }
